...
public class CheckList extends AppCompatActivity {
    ...
    public boolean onCreatePanelMenu(int featureId, @NonNull Menu menu) {
        ...
        if(MyConstants.MY_SELECTIONS.equals(header))
        {
            ...
            (MyConstants.MY_LIST_CAMEL_CASE.equals(header))
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.btnMySelections) {
            ...
            new AlertDialog.Builder(this).setTitle("Delete default data")
                    .setMessage("Are you sure?\n\nAs this will delete the data provided by(Pack With Me) while installing.")
        ...
        else if(itemId==R.id.btnReset)
        {
            new AlertDialog.Builder(this).setTitle("Reset to default")
                    .setMessage("Are you sure?\n\nAs this will load the default data provide by(Pack With Me)"+
